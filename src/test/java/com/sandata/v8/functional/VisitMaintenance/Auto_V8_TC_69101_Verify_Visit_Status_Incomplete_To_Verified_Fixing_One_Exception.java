 ...
 */
public class Auto_V8_TC_69101_Verify_Visit_Status_Incomplete_To_Verified_Fixing_One_Exception extends BaseTest {
    ...
    public void Auto_V8_TC_63053_VM_Verify_User_Is_Able_To_Filter_Visits_Status(String dummyData) throws IOException {
       ...
       vmFilter.enterFilterEmployee("Employee");
      ...
      //  vd.EnterCustomCallDate();
        wrapper.EnterDynamicData("VD_Call_Log_Date", visitStartDate);
