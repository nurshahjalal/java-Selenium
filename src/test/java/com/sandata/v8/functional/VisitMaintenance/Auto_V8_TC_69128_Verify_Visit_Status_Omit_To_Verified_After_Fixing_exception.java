 ...
 */
public class Auto_V8_TC_69128_Verify_Visit_Status_Omit_To_Verified_After_Fixing_exception extends BaseTest {
    ...
    public void Auto_V8_TC_69128_Verify_Visit_Status_Omit_To_Verified_After_Fixing_exception (String dummyData) throws IOException {
       ...
       vmFilter.EnterCustomFromDate(2);
       vmFilter.enterFilterEmployee("Employer");
       vmFilter.selectFromVisitStatus("Incomplete");
        ...
        String visitStartDate = wrapper.getTextBoxValue("Visit_St_DT_ED");
		...
		vd.SelectReasonCode("VM_Detail_Reason_code");
		vd.SaveGeneral();
...
//    		   empName.split(";")[1],"CallOut_Time","G0156");
		...
		vmFilter.selectFromVisitStatus("Omit");
